...
const Update = ({ editData, handleUpdate }) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-red from-green-100 to-green-300">
            <div className="w-full max-w-lg bg-red shadow-lg rounded-lg p-8 my-5">
                <h2 className="text-3xl font-bold text-center text-balck-800 mb-6">Student Registration</h2>
